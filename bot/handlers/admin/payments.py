...
async def show_wata_management_menu(callback: CallbackQuery, state: FSMContext):
    ...
    text = (
        ...
        "• Стандарт: 500$ (50.000₽)\n"
        "• <b>По рекомендации WaveMesh: 150$ (15.000₽)</b>\n"
        ...
        "• Менеджер в Telegram: @Nikita_WATA (напишите, что вы от <b>WaveMesh</b> для снижения платежа до 150$).\n"
...
async def show_platega_management_menu(callback: CallbackQuery, state: FSMContext):
    ...
    text = (
        ...
        "2. Скажите, что вы от <b>@wavemesh</b> — получите скидку на подключение.\n"
